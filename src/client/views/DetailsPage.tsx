                ...
                <div className="col-12">
                    <article className="card my-2 shadow">
                        <div className="card-body">
                            ...
                            <div className=' card-footer bg-transparent border-info d-flex align-items-center justify-content-between m-2 '>
                                <Link className='btn btn-sm btn-primary mt-2 ' to='/portfolio'> Back!</Link>
                                <span>
