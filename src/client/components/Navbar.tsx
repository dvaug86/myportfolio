...
const Navbar: React.FC<NavbarProps> = (props) => { //learn strongtyping props and come up with an opinion
    return (
        <nav className=" nav justify-content-between bg-light align-items-center shadow p-3 mb-5 ">
            <div></div>
            ...
            <div className="links d-flex align-items-end flex-column py-2">
                                ...
                                <a href="https://www.linkedin.com/in/david-vaughan-97492774/">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="black" className="bi bi-linkedin  mt-2 me-2" viewBox="0 0 16 16">
